/* ============================================
   ERGOVIA - Marketing Page Scripts
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const CONFIG = {
        ...
        CHECKOUT_URL: 'https://ergovia-ai.com/onboarding'
    };
        ...
        modal.innerHTML = `
            ...
            <div class="modal-content">
                ...
                <form id="lead-capture-form">
                    ...
                    <p class="form-note">We'll set up your AI assistant</p>
                </form>
            ...
            if (result.checkoutUrl) {
                ...
                if (typeof gtag !== 'undefined') {
                    gtag('event', 'begin_checkout', {
                        currency: 'USD',
                        value: 297,
                        items: [{ item_name: 'Ergovia Monthly', price: 297 }]
                    });
                }
    ...
    if (typingMessage && chatMessages) {
        setTimeout(function() {
            ...
            aiResponse.innerHTML = `
                ...
                <p style="background: rgba(26, 54, 93, 0.3); padding: 10px; border-radius: 8px; margin: 8px 0;">
                    pay.ergovia.ai/b/xyz123
                </p>
                <p>Once paid, you'll receive instant confirmation.</p>
    ...
    console.log('%c Ergovia ', 'background: linear-gradient(135deg, #1a365d, #c9a962); color: white; font-size: 24px; padding: 10px 20px; border-radius: 8px;');
    console.log('%c We\'re hiring! hello@ergovia.ai ', 'color: #1a365d; font-size: 14px;');
